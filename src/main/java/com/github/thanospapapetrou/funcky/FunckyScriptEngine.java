...
public class FunckyScriptEngine extends AbstractScriptEngine implements Compilable, Invocable {
	...
	private static final Class<Library>[] BUILTIN_LIBRARIES = (Class<Library>[]) new Class<?>[] {Prelude.class, Booleans.class, Numbers.class, Characters.class, Pairs.class, Lists.class};
